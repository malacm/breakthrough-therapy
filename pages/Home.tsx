    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-screen min-h-[500px] sm:min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-stone-100 mb-8 sm:mb-10 max-w-2xl mx-auto font-light leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            ...
            <Link to="/services" className="w-full sm:w-auto">
              <Button variant="secondary" size="lg" className="w-full sm:w-auto bg-white/90 text-stone-800 hover:bg-white">
                View Services
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-16 h-16 sm:w-24 sm:h-24 bg-sage-200 rounded-full -z-10 opacity-50"></div>
              <img 
              ...
              />
              <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-stone-100 max-w-[85%] sm:max-w-xs">
                <p className="font-serif italic text-stone-600 text-sm sm:text-base md:text-lg">"Healing happens when we feel safe enough to feel."</p>
              </div>
            </div>
            <div>
              <h2 className="font-serif text-3xl sm:text-4xl font-bold text-stone-800 mb-4 sm:mb-6">The Approach</h2>
              <div className="h-1 w-20 bg-sage-500 mb-6 sm:mb-8"></div>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-stone-800 mb-3 sm:mb-4">The Services</h2>
            <p className="text-stone-500 max-w-xl mx-auto text-sm sm:text-base px-4">Traditional Chinese medicine modalities tailored to your individual needs.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {SERVICES.map((service) => {
              ...
              return (
                <div key={service.id} className="group bg-stone-50 p-8 rounded-2xl hover:shadow-xl transition-all duration-300 border border-stone-100 hover:border-sage-200">
                  <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300">
                    <IconComponent className="h-7 w-7 text-sage-600" />
                  </div>
                  <h3 className="font-serif text-xl font-bold text-stone-800 mb-3">{service.title}</h3>
                  <p className="text-stone-600 text-sm leading-relaxed mb-6">{service.description}</p>
                  <Link to="/services" className="inline-flex items-center text-sage-700 text-sm font-semibold group-hover:gap-2 transition-all">
      ...
      {/* Testimonials */}
      <section className="py-12 sm:py-16 md:py-24 bg-sage-50 border-y border-sage-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-stone-800 mb-8 sm:mb-12">Stories of Healing</h2>
      ...
      {/* CTA */}
      <section className="py-12 sm:py-16 md:py-24 bg-stone-800 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            <p className="text-stone-300 text-base sm:text-lg mb-6 sm:mb-8">Book your appointment and experience the depth of traditional Chinese medicine.</p>
            <Link to="/contact" className="inline-block w-full sm:w-auto">
                <Button variant="primary" size="lg" className="w-full sm:w-auto bg-white text-stone-900 hover:bg-sage-100 hover:text-stone-900 border-none shadow-none">
