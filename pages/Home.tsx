        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            ...
            <div ref={approachTextRef}>
              ...
              <p className="approach-anim text-earth-600 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
                Herbal prescriptions are written as custom formulas, tailored to the individual and are revised as conditions change. While patent formulas can serve as a good starting point, they rarely capture the fullness of the situation or the novelty that is you.
              </p>
              <p className="approach-anim text-earth-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
                Breaking through old patterns demands returning to basics – understanding how illness arises, how it evolves, and how to intervene precisely and appropriately is my foundation. The goal is not temporary relief, but clear, noticeable change that holds over time.
              </p>
